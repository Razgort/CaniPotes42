...
import { SkeletonList, toast } from '@org/ui';
...
export function DogDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Vaccine placeholder for story 6.2 */}
      <div className="rounded-lg border bg-card p-4">
        <h2 className="font-medium mb-2">Vaccins</h2>
        <p className="text-sm text-muted-foreground">
          La gestion des vaccins sera disponible prochainement.
        </p>
      </div>
